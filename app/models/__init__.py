...
from .shared_secret import SharedSecret, SharedSecretAttachment  # noqa: F401
...
__all__ = [
    ...
    'AuditLog', 'CostRecord', 'ProjectSecret', 'SharedSecret',
    'SharedSecretAttachment', 'ChatConversation',
